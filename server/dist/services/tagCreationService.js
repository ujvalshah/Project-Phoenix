 ...
 */
export async function createOrResolveTag(name, options) {
    // Normalize input
 ...
 */
export async function createOrResolveTags(names, options) {
...
//# sourceMappingURL=tagCreationService.js.map