 ...
 */
export async function cleanupOrphanedMedia(orphanAgeMinutes = 60) {
    ...
    try {
        ...
        for (const media of orphanedMedia) {
            try {
                ...
                const cloudinaryDeleted = await deleteFromCloudinary(media.cloudinary.publicId, media.cloudinary.resourceType);
 ...
 */
export async function markMediaAsOrphaned(entityType, entityId) {
    const logger = getLogger();
    try {
