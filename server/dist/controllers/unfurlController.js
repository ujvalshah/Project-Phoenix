 ...
 */
export async function unfurlUrl(req, res) {
    try {
        ...
        const requestLogger = createRequestLogger(req.id || 'unknown', req?.user?.id, req.path);
        requestLogger.error({
...
//# sourceMappingURL=unfurlController.js.map