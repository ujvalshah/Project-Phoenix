...
const supportingMediaSchema = z.preprocess((val) => Array.isArray(val) ? val : [], z.array(supportingMediaItemSchema)).optional();
// Schema for document object
// Coerce null/undefined to empty array
const documentSchema = z.preprocess((val) => Array.isArray(val) ? val : [], z.object({
    title: z.string(),
    url: z.string(),
    type: z.string(),
    size: z.string(),
 ...
 * Coerce null/undefined to empty array
 */
const externalLinksSchema = z.preprocess((val) => Array.isArray(val) ? val : [], z.array(externalLinkSchema)).optional();
/**
...
const baseArticleSchema = z.object({
    ...
    tags: z.preprocess((val) => Array.isArray(val) ? val : [], z.array(z.string())).default([]),
    ...
    images: z.preprocess((val) => Array.isArray(val) ? val : [], z.array(z.string())).optional(),
    ...
    mediaIds: z.preprocess((val) => Array.isArray(val) ? val : [], z.array(z.string())).optional(),
    // Legacy fields
    video: z.string().optional(),
    // Coerce null/undefined to empty array for themes (defensive coding)
    themes: z.preprocess((val) => Array.isArray(val) ? val : [], z.array(z.string())).optional(),
    ...
    customCreatedAt: z.string().refine((val) => {
        if (!val)
    ...
    tagIds: z.preprocess((val) => Array.isArray(val) ? val : [], z.array(z.string())).optional(),
});
...
export const createArticleSchema = baseArticleSchema.strict().refine((data) => {
 ...
 */
export function logCategoryIdsDeprecation(requestId, userId, route, categoryIds) {
 ...
 */
export function preprocessArticleRequest(body, requestId, userId, route) {
