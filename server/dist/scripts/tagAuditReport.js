...
async function runAudit() {
    ...
    try {
        ...
        const emptyTagsArticles = [];
        const whitespaceTagsArticles = [];
        const duplicateTagsArticles = [];
        const badCategoriesArticles = [];
        const missingCategoryIdsArticles = [];
        const legacyStructureArticles = [];
        // Breakdown counters
        const emptyTagsBySource = {};
        const emptyTagsByYear = {};
        const whitespaceTagsBySource = {};
        const whitespaceTagsByYear = {};
        const duplicateTagsBySource = {};
        const duplicateTagsByYear = {};
        const badCategoriesBySource = {};
        const badCategoriesByYear = {};
        const missingCategoryIdsBySource = {};
        const missingCategoryIdsByYear = {};
        ...
        for await (const article of cursor) {
            ...
            const hasBadCategories = categories.some(cat => !cat || typeof cat !== 'string' || cat.trim().length === 0);
            if (hasBadCategories) {
 ...
 * Generate Markdown report
 */
function generateMarkdownReport(report, riskLevel) {
...
export { runAudit };
//# sourceMappingURL=tagAuditReport.js.map