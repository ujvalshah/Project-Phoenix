...
import { metricsMiddleware, isMetricsEnabled, hasMetricsToken, isAuthorizedMetricsRequest, renderPrometheusMetrics, } from './utils/metrics.js';
// Database
...
// Public homepage micro-header copy (no auth required).
app.get('/api/config/home-micro-header', async (_req, res) => {
    try {
...
app.use((err, req, res, next) => {
    const requestLogger = createRequestLogger(req.id || 'unknown', req.userId, req.path);
