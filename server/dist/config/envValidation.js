...
export function validateEnv() {
    ...
    const enforceTokenVersion = result.data.ENFORCE_TOKEN_VERSION ??
 ...
 */
export function resetValidatedEnvForTests() {
 ...
 */
const BUILTIN_CORS_BROWSER_ORIGINS = ['https://nuggets.one'];
/**
